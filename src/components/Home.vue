	...
	<el-row class="panel">
		...
		<el-col :span="24" class="panel-center">
			...
			<aside style="width:230px;">
				<h5 class="admin"><i class="fa fa-user" aria-hidden="true" style="margin-right:5px;"></i>欢迎系统管理员：您已登录成功</h5>
...
<script>
  export default {
    ...
    methods: {
			...
			handleopen(){
				console.log('dev_env handleopen');
			},
			handleclose(){
				console.log('dev_env handleclose');
			},
            handleselect:function(a,b){
            },
			//退出登录
			logout:function(){
				console.log("dev_env exit")
				var _this=this;
