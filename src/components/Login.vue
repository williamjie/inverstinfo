...
<script>
  export default {
    ...
    methods: {
      ...
      handleSubmit2(ev) {
        var _this=this;
        console.log("dev_env:",this.ruleForm2.account)
        console.log("dev_env:",this.ruleForm2.checkPass)
        this.$refs.ruleForm2.validate((valid) => {
          console.log('dev_env valid:',valid)
          var account = this.ruleForm2.account
          var password = this.ruleForm2.checkPass
            if (valid && account== "admin" && password=="admin") {
